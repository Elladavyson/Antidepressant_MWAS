...
sink(paste0(outdir, cohort, "_AD_MRS_assoc.log"))
...
print(paste0('Read in the Antidepressant exposure phenotype for ', cohort, ' : \n Number of cases: ',
             nrow(ad_pheno %>% 
                    filter(antidep==1)), 
             '\n Number of controls: ',
             nrow(ad_pheno%>% 
...
print(paste0('Read in the Antidepressant exposure phenotype for ', cohort, ' after merging with MRS and covariates: \n Number of cases: ',
             nrow(MRS_covs_pheno %>% 
                    filter(antidep==1)), 
             '\n Number of controls: ',
             nrow(MRS_covs_pheno%>% 
